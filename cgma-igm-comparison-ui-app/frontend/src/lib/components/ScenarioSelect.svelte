<script lang="ts">
	...
	let { value = $bindable(), scenarios, onchange }: Props = $props();
...
<span class="pill-field" title="Scenario">
	<span class="pill-cap">SCN</span>
	<select {value} onchange={handle} disabled title="Locked to 2D for now">
