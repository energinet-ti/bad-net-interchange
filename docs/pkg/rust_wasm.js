...
/**
 * @param {any} igm_records_js
 * @param {any} cgma_entries_js
 * @param {string} selected_version
 * @param {number} warning_limit
 * @param {number} error_limit
 * @returns {any}
 */
export function compare_records(igm_records_js, cgma_entries_js, selected_version, warning_limit, error_limit) {
    const ptr0 = passStringToWasm0(selected_version, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.compare_records(igm_records_js, cgma_entries_js, ptr0, len0, warning_limit, error_limit);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function extract_igm_record(file_name, zip_bytes) {
    const ptr0 = passStringToWasm0(file_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(zip_bytes, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.extract_igm_record(ptr0, len0, ptr1, len1);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @param {boolean} reverse_sign
 * @returns {any}
 */
export function parse_cgma_inhouse(xml_text, reverse_sign) {
    const ptr0 = passStringToWasm0(xml_text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parse_cgma_inhouse(ptr0, len0, reverse_sign);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
